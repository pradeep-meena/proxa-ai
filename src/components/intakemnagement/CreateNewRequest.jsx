...
const CreateNewRequest = () => {
  return (
    <div className="container mt-5">
      ...
      >
        <div>
          <h3 className="fw-bold" style={{ textAlign: "start", margin: 0 }}>
            Create New Request
          </h3>
    ...
    `}
      ...
      <form>
        ...
        >
          What is the category of your resquest ?
        </h5>
        ...
        <div className="row">
          <div className=" col-md-4 mb-4">
            ...
            <input
              type="text"
              id="deliveryDate"
              placeholder="Service Duration (in months/years)"
              className="form-control p-3"
            />
          </div>
          <div className="col-md-4 mb-3">
        ...
        <div className="row mb-3">
          <div className="col-md-4 mb-3">
            <input
              type="text"
              id="name"
              placeholder="Authorized Singnatory"
              className="form-control p-3"
            />
          </div>
          <div className="col-md-4 mb-3">
        ...
        <div className="row mb-3">
          <div className="col-md-4 mb-3 ">
            <input type="checkbox" />
            <span> is there a subcontractor involved </span>
          </div>
          <div className="col-md-8 mb-3">
            <input
              type="text"
              id="department"
              placeholder="Additional information about the subcontractor(if checked)"
              className="form-control p-3"
            />
          </div>
        </div>
        ...
        <input type="checkbox" /> Does it involve cloud?
        <br />
