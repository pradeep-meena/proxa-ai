...
function SupplierEditPage() {
  ...
  <div className="col-md-6">
    ...
    <input type="text" className="form-control" id="inputPassword4" placeholder='Enter The Cantact Detail'/>
  </div>
  <div className="col-md-6">
  ...
  <div className="col-md-6">
    ...
    <input type="email" className="form-control" id="inputCity" placeholder='Enter The Email'/>
  </div>
  <div className="col-md-6">
    <label for="inputCity" className="form-label">Address </label>
    <input type="text" className="form-control" id="inputCity" placeholder='Enter YOur Address'/>
  </div>
  ...
  <div className="col-6">
    ...
    <input type="text" className="form-control" id="inputAddress2" placeholder="Enter Your Sub Category "/>
  </div>
  <div className="col-md-6">
